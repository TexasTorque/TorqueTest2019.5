// pathfinder command for 4 wheel drive 
...
public class DrivePath extends Command {
    ...
    @Override
    protected void init() {
        //feedback.resetDriveEncoders(); < UNCOMMENT THIS 
        feedback.zeroYaw();
	...
	protected void continuous() {
        ...
        // ^ UNCOMMENT THAT STUFF ONCE THE DRIVEBASE IS SET UP
        // CHANGE THIS STUFF TOO THAT IS UNDERNEATH
        input.setDBLeftSpeed(0/*leftSpeed*/);
        input.setDBRightSpeed(0/*rightSpeed*/);
